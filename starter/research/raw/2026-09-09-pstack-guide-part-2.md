...
Origin: Article body pasted by the user in the September 22 conversation. Publication date comes from the supplied post footer. No canonical URL was supplied. Navigation, the embedded Part 1 preview, image captions, and social interface furniture are omitted. The body below preserves the supplied wording; headings and prompt blocks receive Markdown formatting.
